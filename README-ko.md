...
`hermes-omx-notify`는 **bridge core**입니다. Hermes가 로컬 OMX/Codex 세션을 다룰 수 있도록 작은 HTTP service와 helper CLI를 제공합니다. 로컬 log와 tmux에서 세션을 찾고, Codex 답변 원문을 읽고, visible tmux pane에 후속 명령을 전달하며, 선택된 이벤트를 Hermes Gateway를 통해 Discord로 보냅니다.
